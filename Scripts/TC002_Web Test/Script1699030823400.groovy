...
WebUI.verifyElementText(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/h2_Login'), 'Login')
...
WebUI.verifyElementText(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/h2_Make Appointment'), 'Make Appointment')
...
WebUI.click(findTestObject('Object Repository/OR Web/Page_CURA Healthcare Service/td_15'))
